...
const Home = () => {
  ...
  var fectedUrl = "https://via.placeholder.com/500";
  //    bg-[url('https://mdbcdn.b-cdn.net/img/new/slides/146.webp')]
  useEffect(() => {
    dispatch({
      type: "PAYMENT_FALSE",
    });
    ...
    dispatch({
      type: "SET_TITLE",
      payload: { title: "Dash Dev" },
    });
  }, []);
  return (
    <div className="flex overflow-y-auto justify-center items-center bg-[url('https://mdbcdn.b-cdn.net/img/new/slides/146.webp')] bg-no-repeat bg-scroll bg-cover">
